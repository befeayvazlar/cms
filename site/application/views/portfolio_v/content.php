                                ...
                                <div class="sidebar">
                                    <div class="block clearfix">
                                        ...
                                        <ul class="list margin-clear">
                                            ...
                                            <li><strong>URL: </strong> <span class="text-right"><a href="<?php echo $portfolio->portfolio_url; ?>" rel="nofollow" target="_blank"><?php echo $portfolio->portfolio_url; ?></a></span></li>
                                        </ul>
                                    </div>
                                </div>
                            </aside>
                                ...
                                <div class="col-sm-3">
                                    <div class="image-box style-2 mb-20 bordered light-gray-bg">
                                        <div class="overlay-container overlay-visible">
                                            ...
                                            $image = get_picture("portfolio_v", get_portfolio_cover_image($portfolio->id), "276x171");
                                            ?>
