<section class="clearfix pv-40">
    <div class="container">
        <div class="justify-content-lg-center">
            ...
            <h2 class="mt-4 text-center"><strong>Portfolyalarımız</strong></h2>
                ...
                <?php foreach ($portfolios as $portfolio){ ?>
                    ...
                    <div class="image-box style-2 mb-20 shadow bordered light-gray-bg text-center">
                        <div class="overlay-container">
                            <img src="<?php echo get_picture("portfolio_v", get_portfolio_cover_image($portfolio->id), "276x171"); ?>" alt="<?php echo $portfolio->title;?>">
                        </div>
                        <div class="body">
