                ...
                <div class="col-lg-8">
                    <div class="testimonial text-center">
                        <div class="testimonial-image">
                            <img src="<?php echo get_picture("testimonials_v",$testimonial->img_url,"90x90"); ?>" alt="<?php echo $testimonial->full_name; ?>" title="<?php echo $testimonial->full_name; ?>" class="rounded-circle">
                        </div>
                        <h3><?php echo $testimonial->title; ?></h3>
                        <div class="separator"></div>
                        <div class="testimonial-body">
                            <blockquote>
                                <p><?php echo character_limiter($testimonial->description,200); ?></p>
                            </blockquote>
