...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?v=3.exp&amp;key=AIzaSyAZhIR8Byuk2fLpuxjxHEnfUnj4_0knAl0"></script>
<script id="mapScriptTag" data-lat="<?php echo $settings->lat; ?>" data-long="<?php echo $settings->lng; ?>" data-title="<?php echo $settings->company_name; ?>" data-marker="<?php echo base_url('assets/images');?>/map_marker.png" type="text/javascript" src="<?php echo base_url("assets"); ?>/js/google.map.config.js"></script>
<!-- Background Video -->
