                            ...
                            <nav class="navbar navbar-expand-lg navbar-light p-0">
                                <div class="navbar-brand clearfix hidden-lg-up">
                                    ...
                                    <div id="logo-mobile" class="logo">
                                        <a href="<?php echo base_url(); ?>"><img id="logo-img-mobile" src="<?php echo get_picture("settings_v", $settings->mobile_logo ,"300x70"); ?>" alt="<?php echo $settings->company_name; ?>"></a>
                                    </div>
                                    <?php } else { ?>
                                        <div id="logo-mobile" class="logo">
                                            <a href="<?php echo base_url(); ?>"><img id="logo-img-mobile" src="<?php echo get_picture("settings_v", $settings->logo ,"150x35"); ?>" alt="<?php echo $settings->company_name; ?>"></a>
                                        </div>                                    <?php } ?>
                                    <!-- name-and-slogan -->
                                    <div class="site-slogan text-center">
                                        <?php echo $settings->slogan; ?>
                                ...
                                <div class="collapse navbar-collapse" id="navbar-collapse-1">
                                    ...
                                    <ul class="navbar-nav ml-xl-auto">
                                        <?php drawMenus2(buildTree($menus)); ?>
                                    </ul>
