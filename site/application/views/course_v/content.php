    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center col-md-offset-2 pv-20">
                ...
                <div class="separator object-non-visible mt-10" data-animation-effect="fadeIn" data-effect-delay="100"></div>
                <h3 class="text-center object-non-visible" data-animation-effect="fadeIn" data-effect-delay="100"><i class="fa fa-calendar"></i> <?php echo get_readable_date($course->event_start_date); ?> - <?php echo get_readable_date($course->event_end_date); ?></h3>
            </div>
        </div>
    </div>
</div>
