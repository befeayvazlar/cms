    ...
    <div class="col-md-12">
        <div class="widget p-lg">
            ...
            <?php } else { ?>
                ...
                <div class="m-b-xl">
                    <a href="<?php echo base_url("services/new_form"); ?>" class="btn btn-outline btn-primary btn-sm"> <i class="fa fa-plus"></i> Yeni Ekle</a>
                </div>
                    ...
                    <tbody class="sortable" data-url="<?php echo base_url("services/rankSetter"); ?>">
                        ...
                        <?php foreach($items as $item) { ?>
                            ...
                            <tr id="ord-<?php echo $item->id; ?>">
                                ...
                                <td style="font-size:14px; text-transform:capitalize;"><a href="<?php echo base_url("services/update_form/$item->id"); ?>"><?php echo $item->title; ?></a></td>
                                <td width="75">

                                        <a href="<?php echo get_picture($viewFolder,$item->img_url, "555x343"); ?>" data-lightbox="resim" data-title="<?php echo $item->title; ?>">
                                            <img width="200" src="<?php echo get_picture($viewFolder,$item->img_url, "350x217"); ?>" alt="<?php echo $item->title; ?>"
                                             class="img-rounded">
                                        </a>
