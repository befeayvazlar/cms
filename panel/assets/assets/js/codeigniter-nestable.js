...
function makeLI(elem) {
    ...
    html.push('<div class="dd-handle">' + elem.menu_name + '</div><div class="dd-buttons"><button data-url="'+base_url+'menu/delete/'+elem.menu_id+'" class="btn btn-xs btn-danger pull-right remove-btn">Sil</button><a href="'+base_url+'menu/update_form/'+elem.menu_id+'" class="m-r-xs btn btn-xs btn-warning pull-right">Düzenle</a></div>');
