...
class Portfolio extends CD_Controller
{
    public $viewFolder = "";
    ...
    public function save(){
        ...
        if($validate){
	        ...
	        // Proje/Portfolio Tamamlanma/Bitiş Tarihi MySQL formatı
    ...
    public function imageDelete($id, $parent_id){
        ...
        if($delete){
            ...
            $image_255x157 = "255x157";
            $image_276x171 = "276x171";
            $image_1080x426 = "1080x426";

            unlink("uploads/{$this->viewFolder}/$image_255x157/$fileName->img_url");
            unlink("uploads/{$this->viewFolder}/$image_276x171/$fileName->img_url");
            unlink("uploads/{$this->viewFolder}/$image_1080x426/$fileName->img_url");
