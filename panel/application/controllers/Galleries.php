...
class Galleries extends CD_Controller
{
    public $viewFolder = "";
...
//			    $delete_folder = rmdir($path);
                ...
                $delete_folder = deleteAll($path);

                $modelName  = ($gallery->gallery_type == "image") ? "image_model" : "file_model";
	...
	/* Galeri Elemanları içi kullanılan metodlar */
    ...
    public function file_upload_old_method($gallery_id, $gallery_type, $folder_name){
    ...
    public function file_upload($gallery_id, $gallery_type, $folder_name){
        ...
        if($gallery_type == "image"){
            //Simple Image...
            $image_252x156 = upload_picture($_FILES["file"]["tmp_name"], "uploads/$this->viewFolder/images/$folder_name/", 252, 156, $file_name );
	...
	/* Video Galeri için kullanılan metodlar */
