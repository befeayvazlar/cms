...
class Product extends CI_Controller {
	...
	public function save(){
		...
		if($validate) {
			...
			if($insert) {
				...
				$alert = array(
					"title"     => "Hata",
					"text"      => "Ürün ekleme sırasında hata oluştu.",
					"type"      => "error",
				);
			}
	...
	public function update($id){
		...
		if($validate) {
			...
			if($update) {
				...
				$alert = array(
					"title"     => "Hata",
					"text"      => "Ürün güncelleme sırasında hata oluştu.",
					"type"      => "error",
				);
			}
			//İşlemin sonucunu session'a yazma işlemi
	...
	public function delete($id){
		...
		if($delete) {
			...
			$alert = array(
				"title"     => "Hata",
				"text"      => "Ürün silme sırasında hata oluştu.",
				"type"      => "error",
			);
		}
		//İşlemin sonucunu session'a yazma işlemi
	...
	public function imageDelete($id, $parent_id){
		...
		if($delete) {
			$alert = array(
				"title"     => "İşlem Başarılı",
				"text"      => "Ürün resmi başarılı şekilde silindi.",
				"type"      => "success",
			);
			...
			$alert = array(
				"title"     => "Hata",
				"text"      => "Ürün resmi silme sırasında hata oluştu.",
				"type"      => "error",
			);
			//redirect(base_url("product/image_form/$parent_id"));
		}
	...
	public function image_upload($id){
		$file_name = convertToSEO(pathinfo($_FILES["file"]["name"], PATHINFO_FILENAME)). "." . convertToSEO(pathinfo($_FILES["file"]["name"], PATHINFO_EXTENSION));
