...
class Users extends CD_Controller
{
    public $viewFolder = "";
    ...
    public function save(){
        ...
        $this->form_validation->set_message(
            array(
	            ...
	            "matches"       => "Şifreler birbiriyle uyuşmamaktadır",
	            "min_length"    => "Şifreniz en az 8 karakterden oluşmalıdır",
	            "max_length"    => "Şifreniz en fazla 16 karakterden oluşmalıdır"
            )
        );
        ...
        if($validate){
            ...
            $update = $this->user_model->update(array("id" => $id),
	                array(
		                ...
		                "full_name"         => $this->input->post("full_name"),
		                "email"             => $this->input->post("email"),
		                "user_role_id"      => !empty($this->input->post("user_role_id")) ? $this->input->post("user_role_id") : $user_role_id
	                )
	            );
