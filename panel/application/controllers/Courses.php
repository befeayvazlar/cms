...
class Courses extends CD_Controller
{
    public $viewFolder = "";
    ...
    public function save(){
        ...
        $this->form_validation->set_rules("event_start_date", "Başlangıç Tarihi", "required|trim");
        $this->form_validation->set_rules("event_end_date", "Bitiş Tarihi", "required|trim");
