                    ...
                    <tbody class="sortable" data-url="<?php echo base_url("brands/rankSetter"); ?>">
                        ...
                        <?php foreach($items as $item) { ?>
                            ...
                            <tr id="ord-<?php echo $item->id; ?>">
                                ...
                                <td style="font-size:14px; text-transform:capitalize;"><a href="<?php echo base_url("brands/update_form/$item->id"); ?>"><?php echo $item->title; ?></a></td>
                                <td width="75">

                                        <a href="<?php echo get_picture($viewFolder,$item->img_url, "350x216"); ?>" data-lightbox="resim" data-title="<?php echo $item->title; ?>">
                                            <img width="200" src="<?php echo get_picture($viewFolder,$item->img_url, "350x216"); ?>"
