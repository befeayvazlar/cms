        ...
        <a href="<?php echo base_url(); ?>" class="navbar-brand">
            <span class="brand-icon">
                ...
                <?php if($settings->logo != "default"){ ?>
                    <img src="<?php echo get_picture("settings_v",$settings->logo, "32x32"); ?>"
                         alt="<?php echo $settings->company_name; ?>"
                         class="img-responsive" width="32">
                <?php } else { ?>
                    <img src="<?php echo base_url("assets/assets/images/index/infinity-logo.png"); ?>"
                         alt="<?php echo $settings->company_name; ?>"
