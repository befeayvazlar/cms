...
<!--            --><?php //} else { ?>
            ...
            <h4 class="m-b-lg widget-title">Menü Ekle/Düzenle</h4>
            <form class="form" method="post" action="<?php echo base_url("menu/save"); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="menu_name" placeholder="Menü Adını giriniz">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="menu_url" id="basic-url" aria-describedby="basic-addon3">
                    </div>
                </div>
                <button type="submit" class="btn btn-primary btn-add">Ekle</button>
            </form>
